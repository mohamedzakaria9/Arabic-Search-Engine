...
class _BooksPageState extends State<home> {
  ...
  Future<Map<String, List<Book>>> fetchBooks({int page = 1}) async {
    final url = Uri.parse(
      'https://search-engine-server-4qq9.vercel.app?page=$page',
    );
          ...
          jsonData
              .map(
                (item) => Book(
                  ...
                  description: item['book_description'] ?? 'No description',
                ),
              )
              .toList();

      return {"الكل": allBooks};
    } else {
      ...
      child: Container(
        ...
        decoration: ShapeDecoration(
          ...
          shape: RoundedRectangleBorder(
            side: BorderSide(width: 1, color: const Color(0xFF6E152E)),
